      ...
      >
        ...
        <div class="d-flex flex-row-fluid flex-column justify-content-between">
          ...
          <a href="#" class="flex-column-auto">
            <img
              :src="asset('/media/logo-dishub.png')"
          ...
          >
            <h3 class="font-size-h1 mt-10 mb-5 text-white">
              TERMINAL ONLINE SISTEM
            </h3>
            <p class="font-weight-lighter opacity-80 text-white">
              PELAKSANAAN TERMINAL OPERASIONAL SYSTEM DALAM TERMINAL BERBASIS DIGITAL.
            </p>
          </div>
          <!--end: Aside content -->
          ...
          >
            <div class="opacity-70 font-weight-bold text-white">
              © 2021 Direktorat Jendral Perhubungan Darat
            </div>
            <!-- <div class="d-flex">
